...
**Live:** [https://relaxed-weasel-docsgpt.cloud.nexlayer.ai](https://relaxed-weasel-docsgpt.cloud.nexlayer.ai)  
...
**docsgpt** is deployed on [Nexlayer](https://nexlayer.ai) — a container-native
...
application:
  ...
  - name: app
    ...
    volumes:
    - name: docsgpt-data
      mountPath: /app/application/uploads
      size: 5Gi
```
